...
const products: Product[] = [
    ...
    },
    {
        ...
        description: 'Sweet, tender organic green peas, flash-frozen to preserve their natural flavour and nutrients.',
        image: peas,
    ...
    },
    {
        id: 6,
        name: 'Fresh Onions',
        description: 'Farm-fresh onions, harvested from sustainable Maharashtra fields for everyday cooking.',
        image: onion,
        details: 'Our Fresh Onions are grown on our family farms using sustainable practices. Firm, flavourful, and harvested at the right maturity, they are perfect for daily cooking, curries, salads, and as a base ingredient for countless dishes.',
        highlights: [
            'Freshly harvested from family farms',
            'Sustainably grown in Maharashtra',
            'Essential for everyday and export cooking',
    ...
    },
    {
        ...
        description: 'Fully matured and naturally dried maize, sustainably sourced from family farms.',
        image: maize,
        details: 'Our Dry Mature Maize is harvested at full maturity and naturally dried on our sustainable farms. Hard, golden, and ideal for grinding into maize flour, making popcorn, or traditional uses. Delivered dry — not frozen or fresh sweet corn.',
        highlights: [
            'Fully matured and naturally dried',
            'Sustainably grown on family farms',
            'Perfect for flour, popcorn, and traditional recipes',
            'Available in 5 kg and 10 kg packs',
        ],
        nutrition: {
        ...
        storage: {
            ...
            usageTips: [
                ...
                'Ideal for traditional recipes and animal feed',
            ],
        },
    },
    {
